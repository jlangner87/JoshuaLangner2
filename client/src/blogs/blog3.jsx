  ...
  return (
    <div className="blog">
      ...
      <div className="blog_content_container">
        ...
        <p className='blog_content'>To get a handle on this, I ended up stealing from my kids. My wife had been using this <a href='https://www.amazon.com/Time-Timer-Home-MOD-Homeschool/dp/B08K9GFDMP/ref=sr_1_4_sspa?keywords=visual%252Btimer&amp&qid=1678809501&amp&sprefix=visual%252Bt%252Caps%252C127&amp&sr=8-4-spons&amp&spLa=ZW5jcnlwdGVkUXVhbGlmaWVyPUEzUTlTNkFDOU1WNEsxJmVuY3J5cHRlZElkPUEwNzYwNTc2MlAxQlRBOUpRTllNUSZlbmNyeXB0ZWRBZElkPUExMDE0MTM2TDQ1UDIxVVlMQVJGJndpZGdldE5hbWU9c3BfYXRmJmFjdGlvbj1jbGlja1JlZGlyZWN0JmRvTm90TG9nQ2xpY2s9dHJ1ZQ&amp&th=1&_encoding=UTF8&tag=adhdbrain-20&linkCode=ur2&linkId=43ca8b53c679b09297cd42aac547bb76&camp=1789&creative=9325'>ADHD Visual Timer</a> for the kids because she knew something I did not. Timers alone are not helpful for ADHD time blindness. The abstract concept of time needs to be communicated in a concrete way. Visual timers do just that, and it has been a game changer.</p>
        ...
        <p className='blog_content'>I have this <a href='https://www.amazon.com/gp/product/B07613BR1D/ref=ppx_yo_dt_b_search_asin_title?ie=UTF8&amp&psc=1&_encoding=UTF8&tag=adhdbrain-20&linkCode=ur2&linkId=37e5c4e48e2361b0ae853758aefd61f1&camp=1789&creative=9325'>Desk Converter</a>. I can switch from a sitting desk to a standing desk in about 10 seconds with the flick of my wrist. This small change of position helps break the monotony just enough to get me back on track.</p>
        ...
        <p className='blog_content'>If my door is open: <em>Please, come on in and talk to me!</em></p>
        <p className='blog_content'>If my door is closed: <em>Come in and do what you need to do, but I don't want to be interrupted.</em></p>
        <p className='blog_content'>If my door is closed and my sign is up: <em>Do not come in unless the there is a life or death situation unfolding.</em></p>
